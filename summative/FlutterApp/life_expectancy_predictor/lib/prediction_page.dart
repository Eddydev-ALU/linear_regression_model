...
class _PredictionPageState extends State<PredictionPage>
  ...
  Future<void> _submit() async {
    ...
    if (!_formKey.currentState!.validate()) {
      setState(() => _errorMessage = 'Please fix the highlighted fields above.');
      return;
    }
        ...
        children: [
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  gradient:
                      const LinearGradient(colors: [_orange, Color(0xFFFF9F5F)]),
          ...
          Text(
            ...
            style: GoogleFonts.dmSans(
                fontSize: 26, fontWeight: FontWeight.w700, color: _navy, height: 1.15),
          ),
          const SizedBox(height: 2),
          Text(
            'Predictor',
            style: GoogleFonts.dmSans(
                fontSize: 26, fontWeight: FontWeight.w700, color: _orange, height: 1.15),
          ),
          const SizedBox(height: 8),
          Text(
            'Enter socio-economic & health indicators to predict\nlife expectancy using the WHO dataset model.',
            style: GoogleFonts.dmSans(fontSize: 13.5, color: _labelGrey, height: 1.5),
          ),
          ...
          if (_usingSampleData) ...[
            ...
            Container(
              ...
              child: Row(
                children: [
                  Icon(Icons.flag_rounded, size: 16, color: _navy.withOpacity(0.6)),
                  const SizedBox(width: 8),
                  Expanded(
                    child: Text(
                      'Loaded: Rwanda 2014  •  Actual life expectancy: ${_rwandaActual.toStringAsFixed(1)} yrs',
                      style: GoogleFonts.dmSans(
                          fontSize: 12, fontWeight: FontWeight.w600, color: _navy.withOpacity(0.7)),
                    ),
                  ),
                ],
              ),
  ...
  Widget _buildField(FieldConfig f) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        hintText: f.hint,
        hintStyle:
            GoogleFonts.dmSans(fontSize: 11.5, color: _labelGrey.withOpacity(0.6)),
        isDense: true,
      ),
      validator: (value) {
        ...
        if (f.isInt && parsed != parsed.roundToDouble()) return 'Whole number only';
        return null;
      },
    );
  }
    ...
    return FadeTransition(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: (_prediction != null ? _orange : Colors.red).withOpacity(0.08),
              blurRadius: 24,
          ...
          border: Border.all(
            color:
                (_prediction != null ? _orange : Colors.redAccent).withOpacity(0.2),
            width: 1.2,
          ),
        ),
        child:
            _prediction != null ? _buildSuccessResult() : _buildErrorResult(),
      ),
    );
  }
  ...
  Widget _buildSuccessResult() {
    final double error =
        _usingSampleData ? (_prediction! - _rwandaActual).abs() : 0;
    ...
    return Column(
      children: [
        ...
        Text('Predicted Life Expectancy',
            style: GoogleFonts.dmSans(
                fontSize: 13, fontWeight: FontWeight.w500, color: _labelGrey)),
        ...
        Row(
          ...
          children: [
            Text(_prediction!.toStringAsFixed(1),
                style: GoogleFonts.dmSans(
                    fontSize: 44,
        ...
        Container(
          ...
          child: Text(_qualityLabel(_prediction!),
              style: GoogleFonts.dmSans(
                  fontSize: 12,
                  fontWeight: FontWeight.w600,
        ...
        if (_usingSampleData) ...[
          ...
          Container(
            ...
            child: Column(
              children: [
                Text('Comparison with Real Data',
                    style: GoogleFonts.dmSans(
                        fontSize: 13,
                        fontWeight: FontWeight.w700,
                        color: _navy)),
                const SizedBox(height: 4),
                Text('Rwanda, 2014 — WHO Dataset',
                    style: GoogleFonts.dmSans(
                        fontSize: 11,
